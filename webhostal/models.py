...
class ContratosPredefinidos(models.Model):
    id_contrato_predefinido = models.BigIntegerField(primary_key=True)
...
class CuentaContrato(models.Model):
    id_cuenta_contrato = models.BigIntegerField(primary_key=True)
...
class EstadoContrato(models.Model):
    id_estado_contrato = models.BigIntegerField(primary_key=True)
...
class EstadoEmpleado(models.Model):
    id_estadoempleado = models.BigIntegerField(primary_key=True)
...
class EstadoHabitacion(models.Model):
    id_estado_habitacion = models.BigIntegerField(primary_key=True)
...
class EstadoHostal(models.Model):
    id_estado_hostal = models.BigIntegerField(primary_key=True)
...
class EstadoHuespedes(models.Model):
    id_estado_huesped = models.BigIntegerField(primary_key=True)
...
class EstadoPedido(models.Model):
    id_estadopedido = models.BigIntegerField(primary_key=True)
...
class EstadoProducto(models.Model):
    id_estado_producto = models.BigIntegerField(primary_key=True)
...
class EstadoProveedor(models.Model):
    id_estadoprov = models.BigIntegerField(primary_key=True)
...
class EstadoUsuario(models.Model):
    id_estado_usuario = models.BigIntegerField(primary_key=True)
...
class Habitaciones(models.Model):
    id_habitacion = models.BigIntegerField(primary_key=True)
...
class Hostal(models.Model):
    id_hostal = models.BigIntegerField(primary_key=True)
...
class Huespedes(models.Model):
    id_huesped = models.BigIntegerField(primary_key=True)
...
class RumboProveedor(models.Model):
    id_rumbo_prov = models.BigIntegerField(primary_key=True)
...
class TipoContrato(models.Model):
    id_tipo_contrato = models.BigIntegerField(primary_key=True)
...
class TipoEmpleado(models.Model):
    id_tipoempleado = models.BigIntegerField(primary_key=True)
...
class TipoHabitacion(models.Model):
    id_tipohabitacion = models.BigIntegerField(primary_key=True)
...
class TipoPlato(models.Model):
    id_tipo_plato = models.BigIntegerField(primary_key=True)
...
class Usuarios(models.Model):
    ...
    id_estado_usuario = models.IntegerField()
